export default [
  {
    ...
    icon: "/blog.png",
    aiPrompt:
      "Give me 5 blog topic ideas in bullet wise only, and based on given niche & outline and give me result in Rich text editor format",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 3 facebook post depends on a given keywords and give output in  in rich text editor format",
    form: [
      {
        label: "Enter Keywords for your post",
        field: "input",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 15 tiktok hash tag depends on a given keywords and give output in  in rich text editor format",
    form: [
      {
